...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-awxy3xu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-awxy3xu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Antonescu/container-awxy3xu.git
cd container-awxy3xu
```
...
```
docker attach container-awxy3xu
```
